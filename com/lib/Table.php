...
global $sgpt;
$sgpt->includeLib('ListTable');

class SGPT_Table extends SGPT_ListTable
{
	protected $id = '';
	...
	public function __construct($id)
	{
		...
		parent::__construct(array(
			'singular'=> 'wp_'.$sgpt->prefix.'_'.$id, //singular label
			'plural' => 'wp_'.$sgpt->prefix.'_'.$id.'s', //plural label
			'ajax' => false
		));
	}
	...
	{
		global $sgpt;
		$this->tablename = $sgpt->tablename($tablename);
	}
