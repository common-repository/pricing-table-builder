function sgptRequestHandler(action, data, params){
    this.action = action;
    this.url = '';
    this.data = data;
    this.callback = '';
...
sgptRequestHandler.prototype.prepareData = function() {
    this.url = ajaxurl;
...
sgptRequestHandler.prototype.run = function(){
    var that = this;
    that.prepareData();
    var settings = {
        url: that.url,
