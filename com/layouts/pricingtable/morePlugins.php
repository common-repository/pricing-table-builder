	...
	<div class="left-block">
		<div class="main-image-block">
			<a href="http://huge-it.com/slider/" target="_blank" rel="content">
				<img src="<?php echo plugins_url( '../../../assets/page/img/slider-logo.png' , __FILE__ ); ?>">
			</a>
		</div>
	</div>
	...
	<div class="left-block">
		<div class="main-image-block">
			<a href="http://huge-it.com/portfolio-gallery/" target="_blank" rel="content">
				<img src="<?php echo plugins_url( '../../../assets/page/img/portfolio.png' , __FILE__ ); ?>">
			</a>
		</div>
	</div>
	<div class="right-block">
		...
		<div class="button-block">
			<a href="http://huge-it.com/portfolio-gallery/" target="_blank"><?php echo"View Plugin";?></a>
		</div>
	</div>
</div>
<div class="element hugeitmicro-item">
	<div class="left-block">
		<div class="main-image-block">
			<a href="http://huge-it.com/wordpress-responsive-slider/" target="_blank"><img src="<?php echo plugins_url( '../../../assets/page/img/responsive-slider.png', __FILE__ ); ?>" /></a>
		</div>
	</div>
	<div class="right-block">
...
<div class="element hugeitmicro-item">
	<div class="left-block">
		<div class="main-image-block">
			<a href="https://wordpress.org/plugins/forms-contact/" target="_blank"><img src="<?php echo plugins_url( '../../../assets/page/img/form-logo.png', __FILE__ ); ?>" /></a>
		</div>
	</div>
	<div class="right-block">
		<div class="title-block"><a href="https://wordpress.org/plugins/forms-contact/" target="_blank"><h3>WordPress Forms</h3></a>
		</div>
		<p>Form builder are one of the most important elements of your website.
			If you need a simple configured and best functioning forms.
		</p>
		<div class="description-block">
		</div>
		<div class="button-block">
			<a href="https://wordpress.org/plugins/forms-contact/" target="_blank">View Plugin</a>
		</div>
	</div>
</div>
<div class="element hugeitmicro-item">
	<div class="left-block">
		<div class="main-image-block">
			<a href="http://huge-it.com/wordpress-gallery/" target="_blank" rel="content">
				<img src="<?php echo plugins_url( '../../../assets/page/img/image-gallery-icon.png' , __FILE__ ); ?>">
			</a>
		</div>
	</div>
	<div class="right-block">
	...
	<div class="left-block">
		<div class="main-image-block">
			<a href="http://huge-it.com/lightbox/" target="_blank" rel="content">
				<img src="<?php echo plugins_url( '../../../assets/page/img/lightbox-logo.png' , __FILE__ ); ?>">
			</a>
		</div>
	</div>
	<div class="right-block">
	...
	<div class="left-block">
		<div class="main-image-block">
			<a href="http://huge-it.com/wordpress-video-gallery/" target="_blank" rel="content">
				<img src="<?php echo plugins_url( '../../../assets/page/img/video-player-logo.png' , __FILE__ ); ?>">
			</a>
		</div>
	</div>
	<div class="right-block">
	...
	<div class="left-block">
		<div class="main-image-block">
			<a href="http://huge-it.com/share-buttons/" target="_blank" rel="content">
				<img src="<?php echo plugins_url( '../../../assets/page/img/share-buttons-logo.png' , __FILE__ ); ?>">
			</a>
		</div>
	</div>
	<div class="right-block">
	...
	<div class="left-block">
		<div class="main-image-block">
			<a href="http://huge-it.com/google-map/" target="_blank" rel="content">
				<img src="<?php echo plugins_url( '../../../assets/page/img/google-maps-logo.png' , __FILE__ ); ?>">
			</a>
		</div>
	</div>
	<div class="right-block">
	...
	<div class="left-block">
		<div class="main-image-block">
			<a href="http://huge-it.com/product-catalog/" target="_blank" rel="content">
				<img src="<?php echo plugins_url( '../../../assets/page/img/product-catalog-logo.png' , __FILE__ ); ?>">
			</a>
		</div>
	</div>
	<div class="right-block">
	...
	<div class="left-block">
		<div class="main-image-block">
			<a href="http://huge-it.com/colorbox/" target="_blank" rel="content">
				<img src="<?php echo plugins_url( '../../../assets/page/img/colorbox-logo.png' , __FILE__ ); ?>">
			</a>
		</div>
	</div>
	<div class="right-block">
